          ...
          <ul className="navbar-nav ml-auto">
            <li className="nav-item">
              <a className="nav-link" href="cart.html">
                <i className="fas fa-dolly-flatbed mr-1 text-gray" />Cart<small className="text-gray">(2)</small></a>
            </li>
            <li className="nav-item">
              <a className="nav-link" href="#">
                <i className="far fa-heart mr-1" /><small className="text-gray"> (0)</small></a>
            </li>
            <li className="nav-item">
              <a className="nav-link" href="#">
                <i className="fas fa-user-alt mr-1 text-gray" />Login</a>
            </li>
          </ul>
        </div>
      </nav>
          ...
          <div className="row align-items-stretch">
            ...
            <div className="col-lg-6">
              ...
              <div className="p-5 my-md-4">
                ...
                <a className="btn btn-link text-dark p-0" href="#"><i className="far fa-heart mr-2" />Add to wish list</a>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="row">
              ...
              <div className="product-overlay">
                <ul className="mb-0 list-inline">
                  <li className="list-inline-item m-0 p-0">
                    <a className="btn btn-sm btn-outline-dark" href="#"><i className="far fa-heart" /></a>
                  </li>
                  <li className="list-inline-item m-0 p-0">
                    <a className="btn btn-sm btn-dark" href="cart.html">Add to cart</a>
                  </li>
                  <li className="list-inline-item mr-0">
                    <a className="btn btn-sm btn-outline-dark" href="#productView" data-toggle="modal"><i className="fas fa-expand" /></a>
                  </li>
                </ul>
              </div>
            </div>
            <h6>
              <a className="reset-anchor" href="detail.html">Kui Ye Chen’s AirPods</a>
            </h6>
        ...
        <div className="col-xl-3 col-lg-4 col-sm-6">
          <div className="product text-center">
            ...
            <h6>
              <a className="reset-anchor" href="detail.html">Air Jordan 12 gym red</a>
            </h6>
        ...
        <div className="col-xl-3 col-lg-4 col-sm-6">
          <div className="product text-center">
            ...
            <h6>
              <a className="reset-anchor" href="detail.html">Cyan cotton t-shirt</a>
            </h6>
        ...
        <div className="col-xl-3 col-lg-4 col-sm-6">
          <div className="product text-center">
            ...
            <h6>
              <a className="reset-anchor" href="detail.html">Timex Unisex Originals</a>
            </h6>
        ...
        <div className="col-xl-3 col-lg-4 col-sm-6">
          <div className="product text-center">
            ...
            <h6>
              <a className="reset-anchor" href="detail.html">Red digital smartwatch</a>
            </h6>
            <p className="small text-muted">$250</p>
          </div>
        </div>
        ...
        <div className="col-xl-3 col-lg-4 col-sm-6">
          <div className="product text-center">
            ...
            <h6>
              <a className="reset-anchor" href="detail.html">Nike air max 95</a>
            </h6>
            <p className="small text-muted">$300</p>
          </div>
        </div>
        ...
        <div className="col-xl-3 col-lg-4 col-sm-6">
          <div className="product text-center">
            ...
            <h6>
              <a className="reset-anchor" href="detail.html">Joemalone Women prefume</a>
            </h6>
            <p className="small text-muted">$25</p>
          </div>
        </div>
        ...
        <div className="col-xl-3 col-lg-4 col-sm-6">
          <div className="product text-center">
            ...
            <h6>
              <a className="reset-anchor" href="detail.html">Apple Watch</a>
            </h6>
            <p className="small text-muted">$351</p>
          </div>
        </div>
            ...
            <form action="#">
              <div className="input-group flex-column flex-sm-row mb-3">
                ...
                <div className="input-group-append">
                  <button className="btn btn-dark btn-block" id="button-addon2" type="submit">
                    Subscribe
                  </button>
                </div>
              </div>
      ...
      <div className="row py-5">
        <div className="col-md-4 mb-3 mb-md-0">
          ...
          <ul className="list-unstyled mb-0">
            <li>
              <a className="footer-link" href="#">Help &amp; Contact Us</a>
            </li>
            <li>
              <a className="footer-link" href="#">Returns &amp; Refunds</a>
            </li>
        ...
        <div className="row">
          ...
          <div className="col-lg-6 text-lg-right">
            <p className="small text-muted mb-0">
              ...
              <a className="text-white reset-anchor" href="https://bootstraptemple.com/p/bootstrap-ecommerce">Bootstrap Temple</a>
            </p>
          </div>
        </div>
      </div>
